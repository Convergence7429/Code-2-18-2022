...
public class Shooter {
    ...
    public static double getXDistanceFromCenterOfHub(double verticalAngle) {
        return ((y - cameraHeight) / Math.tan(Math.toRadians(verticalAngle + cameraAngle - angleError))); // ADD DISTANCE FROM TAPE TO CENTER
    }
    ...
    public static double shooterWheelLinearVelocityToMotorVelocity(double shooterWheelLinearVelocity){ // needs to be defined based on trial and error
